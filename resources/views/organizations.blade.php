...
@section('content')
    <div class="container">
        ...
        <div style="display: flex; justify-content: space-between; margin-top: 30px;"><h1 style="margin-top: 0px;">
                Организации</h1>
            <button value="create-org-form" style="padding: 4px 8px" class="btn btn-success btn-open-modal">Добавить
            </button>
        </div>
        ...
        <x-modal-window id="create-org-form">
            <form style="margin: 20px;" id="CreateOrg">
                ...
                <div class="modal-footer">
                    <button type="button" id="btnCloseCreateModalOrg" class="btn btn-secondary btn-close-modal">
                        Закрыть
                    </button>
            ...
            @if(count($orgs)>0)
                @foreach($orgs as $el)
                    <tr>
                        ...
                        <td><a>
                                <button class="btn btn-danger btn-open-modal" value="{{'delete-opg-'.$el->id}}">
                                    Удалить
                                </button>
                            </a></td>
                    </tr>
                    <x-modal-window id="{{'delete-opg-'.$el->id}}">
                        <h2 style="text-align: center; margin: 30px 0;">Удалить организацию <br/><b>{{$el->name}}</b> ?
                        </h2>
                        <div class="modal-footer">
